...
# ============================================================
# Les calculs sont effectués dans la fonction 'alimentaer_faits_suivi_cpap_jour'
...
#--- TRANSFORM ---
        ...
        print("\n[2/6] Calcul des alertes d'observance et iah...")
...
#--- LOAD : db ---
        print("\n[3/6] Initialisation et alimentation de la faits_suivi_cpap_jour...")
